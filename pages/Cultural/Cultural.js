...
Page({
  ...
  goUrl:function(e){
    if(e.currentTarget.dataset.type == 'text'){
      wx.navigateTo({
        url: '../textImg/textImg?id='+e.currentTarget.dataset.id+'&titles=文化家园',
      })
    }else{
      wx.navigateTo({
        url: '../videosHtml/videosHtml?id='+e.currentTarget.dataset.id+'&titles=文化家园',
      })
    }
  },
